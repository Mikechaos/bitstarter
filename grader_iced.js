...
(function() {
  var $, CHECKSFILE_DEFAULT, HTMLFILE_DEFAULT, assertFileExists, check, checkHtmlFile, checkHtmlFilecontent, cheerio, clone, content, fs, get_content, get_url_content, iced, loadChecks, outJson, program, read_url, rest, sys, __iced_deferrals, __iced_k, __iced_k_noop,
    _this = this;
  ...
  get_content = function(autocb) {
    var test, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = autocb;
    ...
    if (program.url != null) {
      (function(__iced_k) {
        ...
        return __iced_k(get_url_content());
      });
    } else {
  ...
  if (require.main === module) {
    ...
    (function(__iced_k) {
      ...
      return __iced_k(console.log(outJson));
    });
  } else {
